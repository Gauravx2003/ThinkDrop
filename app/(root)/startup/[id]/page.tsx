...
const page = async ({params}:{ params: Promise<{id: string}>}) => {
  ...
  // const { select: editorPosts} = await client.fetch(PLAYLIST_BY_SLUG_QUERY, { slug: 'editor-s-choice'});
  ...
  return (
    <>
       <section className="pink_container !min-h-[230px]">
        <p className="tag font-work-sans bg-secondary tag-tri">{formatDate(post?._createdAt)}</p>
      ...
      <section className="section_container">
        ...
        <div className="space-y-5 mt-10 max-w-4xl mx-auto">
          <div className="flex-between gap-5">
            ...
            <p className="category-tag bg-primary-100">{post.Category}</p>
          </div>
